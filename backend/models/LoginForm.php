...
class LoginForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['username'], 'required','message' => Yii::t('app', '{attribute} không được để trống, vui lòng thử lại.')],
            [[ 'password'], 'required','message' => Yii::t('app', 'Mật Khẩu không được để trống, vui lòng thử lại.')],
    ...
    {
        if ($this->validate()) {
            $login = Yii::$app->user->login($this->getUser(), 3600);
