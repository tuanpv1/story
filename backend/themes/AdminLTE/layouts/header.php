...
//                'data-toggle' => "dropdown",
        ...
        [
            'encode' => false,
//            'label' => Html::tag('li', Html::a(Yii::t('app', 'Đăng xuất'), ['/site/logout'], ['data-method' => 'post', 'data-confirm' => Yii::t('app', "Bạn có chắc chắn muốn đăng xuất?"), 'id' => 'change-text'])),
            'label' => Html::tag('li', Html::a(Yii::t('app', 'Đăng xuất'), ['#'], ['id' => 'change-text'])),
            'url' => false,
        ],
    ];
    echo Nav::widget([
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="proccessLogout">ok</button>
            </div>
        </div>
    </div>
</div>